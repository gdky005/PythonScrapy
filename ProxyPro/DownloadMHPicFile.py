...
def getFile(url1, header, proxies1, mid):
    try:
        if proxies1 is None:
        ...
        if 200 == res.status_code:
            ...
            fileName = str(mid) + "_" + url1[url2.rindex("/") + 1:]

            print("获取文件内容成功，准备写入到文件中：" + fileName)

            fileObject = open("/Users/WangQing/PycharmProjects/ScrapyPro/ProxyPro/manhuaPic/" + fileName, 'w+')
...
for data in resultList:
    ...
    proxies = {scheme: domain}
    code = getFile(url, headers, proxies, mid)
